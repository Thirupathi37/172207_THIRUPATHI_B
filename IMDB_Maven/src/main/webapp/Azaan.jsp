     ...
     <div class = "page-header"><h2>WELCOME</h2></div>
       <div class="row">
             <div class="col-sm-6" style="background-color:lavender;">
                 ...
                 <iframe width="400" height="440" src="https://www.youtube.com/embed/SkaM8NBVAu8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                  </iframe>
             </div>
...
<form action="" method="loginProcess">
