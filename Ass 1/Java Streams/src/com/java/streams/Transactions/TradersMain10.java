...
public class TradersMain10
{
	...
	public static void main(String[] args) {
		...
		List<Trader> names=list.stream().filter(p->p.getCity()=="Pune").sorted(Comparator.comparing(Trader::getName)).collect(Collectors.toList());
		names.forEach(name->System.out.println("Names:"+name.getName()));
